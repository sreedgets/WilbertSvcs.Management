...
namespace WilbertSvcs.Management.Controllers
{
    public class PlantsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PlantId,PlantName,PlantManagerEmail,Address,City,State,ZipCode,County,PrintCompletedOrders")] Plant plant)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PlantId,PlantName,PlantManagerEmail,Address,City,State,ZipCode,County,PrintCompletedOrders")] Plant plant)
        {
            if (id != plant.PlantId)
            {
                return NotFound();
