...
namespace WilbertFSvcs.api.Migrations
{
    ...
    [Migration("20201030154622_createNewStuff")]
    partial class createNewStuff
    {
            ...
            modelBuilder.Entity("WilbertFSvcs.Models.Entities.VaultOrder", b =>
                {
                    ...
                    b.Property<int?>("theDeceasedDeceasedId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("theDeceasedDeceasedId");
            ...
            modelBuilder.Entity("WilbertFSvcs.Models.Entities.VaultOrder", b =>
                {
                    ...
                    b.HasOne("WilbertFSvcs.Models.Entities.Deceased", "theDeceased")
                        .WithMany()
                        .HasForeignKey("theDeceasedDeceasedId");
                });
