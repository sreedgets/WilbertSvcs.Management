        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VaultOrderId = table.Column<int>(type: "int", nullable: false),
                    FuneralHome = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Cemetary = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FuneralDirector = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    GravesideTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DeceasedId = table.Column<int>(type: "int", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    ...
                    AmtPaid = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    PaidTo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TruckNum = table.Column<int>(type: "int", nullable: false),
                    EquipInNeedOfRepair = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ReadyOnTime = table.Column<bool>(type: "bit", nullable: false),
                    AwningSet = table.Column<bool>(type: "bit", nullable: false),
                    EquipPolished = table.Column<bool>(type: "bit", nullable: false),
                    UniformClean = table.Column<bool>(type: "bit", nullable: false),
                    TentSet = table.Column<bool>(type: "bit", nullable: false),
                    ChairsSet = table.Column<bool>(type: "bit", nullable: false),
                    SideWalls = table.Column<bool>(type: "bit", nullable: false),
                    OilTiresChecked = table.Column<bool>(type: "bit", nullable: false),
                    ReasonTentNotSet = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FDArrivalTime = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FDCommentsAndRemarks = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TimeLeftPlant = table.Column<DateTime>(type: "datetime2", nullable: false),
                    MilesTo = table.Column<int>(type: "int", nullable: false),
                    ArrivalTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    SetupTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ReturnTimeInMinutes = table.Column<int>(type: "int", nullable: false),
                    TimeIn_Plant = table.Column<DateTime>(type: "datetime2", nullable: false),
                    RemarksOrProblems = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ReviewedByOffice = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
