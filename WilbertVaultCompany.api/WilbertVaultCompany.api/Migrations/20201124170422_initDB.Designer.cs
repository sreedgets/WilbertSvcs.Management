...
namespace WilbertVaultCompany.api.Migrations
{
    ...
    [Migration("20201124170422_initDB")]
            ...
            modelBuilder.Entity("WilbertVaultCompany.api.Models.Delivery", b =>
                {
                    ...
                    b.Property<string>("FdarrivalTime")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("FDArrivalTime");

                    b.Property<string>("FdcommentsAndRemarks")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("FDCommentsAndRemarks");
                    ...
                    b.HasIndex(new[] { "DeceasedId" }, "IX_Delivery_DeceasedId");

                    b.HasIndex(new[] { "VaultOrderId" }, "IX_Delivery_VaultOrderId");
            ...
            modelBuilder.Entity("WilbertVaultCompany.api.Models.Employee", b =>
                {
                    ...
                    b.HasIndex(new[] { "PlantId" }, "IX_Employee_PlantId");
            ...
            modelBuilder.Entity("WilbertVaultCompany.api.Models.FuneralHome", b =>
                {
                    ...
                    b.HasIndex(new[] { "PlantId" }, "IX_FuneralHome_PlantId");
            ...
            modelBuilder.Entity("WilbertVaultCompany.api.Models.FuneralHomeContact", b =>
                {
                    ...
                    b.HasIndex(new[] { "FuneralHomeId" }, "IX_FuneralHomeContact_FuneralHomeId");
            ...
            modelBuilder.Entity("WilbertVaultCompany.api.Models.Interaction", b =>
                {
                    ...
                    b.HasIndex(new[] { "FuneralHomeId" }, "IX_Interaction_FuneralHomeId");
            ...
            modelBuilder.Entity("WilbertVaultCompany.api.Models.Phone", b =>
                {
                    ...
                    b.HasIndex(new[] { "EmployeeId" }, "IX_Phone_EmployeeId");

                    b.HasIndex(new[] { "FuneralHomeContactId" }, "IX_Phone_FuneralHomeContactId");

                    b.HasIndex(new[] { "FuneralHomeId" }, "IX_Phone_FuneralHomeId");

                    b.HasIndex(new[] { "PlantId" }, "IX_Phone_PlantId");
            ...
            modelBuilder.Entity("WilbertVaultCompany.api.Models.Photo", b =>
                {
                    ...
                    b.HasIndex(new[] { "FuneralHomeId" }, "IX_Photo_FuneralHomeId");

                    b.HasIndex(new[] { "TruckId" }, "IX_Photo_TruckId");
            ...
            modelBuilder.Entity("WilbertVaultCompany.api.Models.Truck", b =>
                {
                    ...
                    b.HasIndex(new[] { "DriverEmployeeId" }, "IX_Truck_DriverEmployeeId");

                    b.HasIndex(new[] { "PlantId" }, "IX_Truck_PlantId");
            ...
            modelBuilder.Entity("WilbertVaultCompany.api.Models.Vault", b =>
                {
                    ...
                    b.HasIndex(new[] { "AllowedToSelectId" }, "IX_Vault_AllowedToSelectId");
            ...
            modelBuilder.Entity("WilbertVaultCompany.api.Models.VaultOrder", b =>
                {
                    ...
                    b.Property<string>("FuneralDirector")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("funeralDirector");

                    b.Property<string>("FuneralHome")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("funeralHome");
                    ...
                    b.Property<string>("NewFuneralDirector")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("newFuneralDirector");

                    b.Property<string>("NewFuneralHome")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("newFuneralHome");
                    ...
                    b.HasIndex(new[] { "CemetaryId" }, "IX_VaultOrder_CemetaryId");

                    b.HasIndex(new[] { "DeceasedId" }, "IX_VaultOrder_DeceasedId");

                    b.HasIndex(new[] { "PlantId" }, "IX_VaultOrder_PlantId");

                    b.HasIndex(new[] { "VaultId" }, "IX_VaultOrder_VaultId");
